...
extension Wood {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<Wood> {
        return NSFetchRequest<Wood>(entityName: "Wood")
    }

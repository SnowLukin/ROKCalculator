...
extension Gems {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<Gems> {
        return NSFetchRequest<Gems>(entityName: "Gems")
    }
    ...
    @NSManaged public var nine: Int64
